    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 px-4 pt-3 pr-12">
        <div className="min-w-0">
          <div className="truncate text-lg font-semibold leading-tight text-[rgb(var(--ct-text-primary)/var(--ct-text-primary-o))]">
            {area}
          </div>
          <div className="mt-0.5 flex items-center gap-1.5 text-[11px] text-[rgb(var(--ct-text-muted)/var(--ct-text-muted-o))]">
            {isHome ? (
              ...
              <span className="text-[rgb(var(--ct-text-muted)/var(--ct-text-faint-o))]">
                Not refreshed
              </span>
            )}
          </div>
        </div>
        <div className="text-3xl font-light tabular-nums text-[rgb(var(--ct-text-secondary)/var(--ct-text-secondary-o))]">
          {temperature}
        </div>
      </div>
